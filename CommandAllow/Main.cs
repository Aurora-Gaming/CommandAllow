...
public class Main : TerrariaPlugin
{
    ...
    public List<Command> AllowCommand = new();
    ...
    {
        CommandDetails commandDetails = new(playerNameIndex,
    ...
    {
        Command command = new(Config.CommandAllowPermission.SFormat(commandName),
            args =>
            {
